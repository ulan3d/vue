  	...
  	var decode = function(html, options) {
  		...
  		return html.replace(regexDecode, function($0, $1, $2, $3, $4, $5, $6, $7, $8) {
  			...
  			if ($1) {
  				...
  				return hasOwn(decodeMap, reference) ? decodeMap[reference] : decodeMap1[reference];
  			}
